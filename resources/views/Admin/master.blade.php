                    ...
                    <div class="col-4">
                        <div class="form-check form-switch card-switch mb-1">
                            ...
                            <label class="form-check-label" for="layout-color-light">
                                <img src="{{asset('backEnd')}}/assets/images/layouts/light.png" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-check form-switch card-switch mb-1">
                            ...
                            <label class="form-check-label" for="layout-color-dark">
                                <img src="{{asset('backEnd')}}/assets/images/layouts/dark.png" alt="" class="img-fluid">
                            </label>
                        </div>
                            ...
                            <div id="layout-boxed">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="layout-mode-boxed">
                                        <img src="{{asset('backEnd')}}/assets/images/layouts/boxed.png" alt="" class="img-fluid">
                                    </label>
                                </div>
                    ...
                    <div class="col-4">
                        <div class="form-check form-switch card-switch mb-1">
                            ...
                            <label class="form-check-label" for="topbar-color-dark">
                                <img src="{{asset('backEnd')}}/assets/images/layouts/topbar-dark.png" alt="" class="img-fluid">
                            </label>
                        </div>
                        <h5 class="font-14 text-center text-muted mt-2">Dark</h5>
                    </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-color-light">
                                    <img src="{{asset('backEnd')}}/assets/images/layouts/sidebar-light.png" alt="" class="img-fluid">
                                </label>
                            </div>
                            <h5 class="font-14 text-center text-muted mt-2">Light</h5>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-size-compact">
                                    <img src="{{asset('backEnd')}}/assets/images/layouts/compact.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-size-small">
                                    <img src="{{asset('backEnd')}}/assets/images/layouts/sm.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="leftbar-size-full">
                                    <img src="{{asset('backEnd')}}/assets/images/layouts/full.png" alt="" class="img-fluid">
                                </label>
                            </div>
